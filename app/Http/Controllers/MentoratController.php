    ...
    $meetings = Mentorat::where('mentor_id', $mentor->id)->get();
     ...
     public function store(Request $request)
     {
         ...
         $validatedData = $request->validate([
             ...
             'subject' => 'required',
             'survey_id' => 'required',
              // Assurez-vous d'inclure survey_id dans les règles de validation
         ]);
     
         // Récupérer l'ID du sondage à partir de la requête
         $surveyId = $request->input('survey_id');
        
        //  dd($surveyId);         // Récupérer l'identifiant du mentor à partir de l'utilisateur connecté
         $mentorId = auth()->id();
         ...
         $meetingData = [
             ...
             'mentor_id' => $mentorId,
             'sondage_id' => $surveyId, // Utiliser l'ID du sondage récupéré
             'domaine' => $validatedData['domaine'],
         ];
      
     
         // Créer un nouvel objet Mentorat avec les données du meeting
         $meeting = new Mentorat($meetingData);
        //  dd($meetingData);
