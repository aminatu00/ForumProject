    ...
    public function store(Request $request)
    {
        ...
        foreach ($spamWords as $spamWord) {
            if (strpos($questionContent, $spamWord) !== false) {
                // Si un mot spam est trouvé dans le contenu, redirigez l'utilisateur avec un message d'avertissement
        ...
        // Si aucune occurrence de mots spam n'est trouvée, continuez avec le traitement de la question
        // Créez la question avec l'ID de l'utilisateur authentifié et l'ID de la catégorie sélectionnée
        $question = Question::create([
            'title' => $request->title,
            'content' => $request->content,
            'user_id' => auth()->id(),
            'category_id' => $request->categorie, // Associez l'ID de la catégorie sélectionnée à la question
        ]);
